...
string isim;
cout << "isminizi girin " << endl;
cin >> isim;

cout << "merhaba " << isim << " loops labina hosgeldin " << endl;
    cout << endl;
...
while (tahmin != secret ){
    ...
    cin >> tahmin;
     ...
     if (tahmin > secret){
         cout << "daha kucuk sayi gir" << endl;
     } else if (tahmin < secret){
         cout << "daha buyuk sayi gir " << endl;
         
     } else {
         cout << "dogru "  << deneme << " kadar denemede bildin " << endl;
     }
}
    cout << endl;
